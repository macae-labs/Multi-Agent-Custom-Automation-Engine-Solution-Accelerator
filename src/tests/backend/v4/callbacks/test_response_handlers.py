...
class TestExtractToolCallsFromContents:
    ...
    def test_extract_tool_calls_with_function_calls(self):
        ...
        with patch(
            ...
            mock_agent_tool_call.assert_any_call(
                tool_name="test_function1", arguments={"arg1": "value1"}
            )
            mock_agent_tool_call.assert_any_call(
                tool_name="test_function2", arguments={"arg2": "value2"}
            )
    ...
    def test_extract_tool_calls_mixed_content(self):
        ...
        with patch(
            ...
            result = _extract_tool_calls_from_contents(
                [mock_function_item, mock_text_item]
            )
    ...
    def test_extract_tool_calls_missing_name_uses_unknown(self):
        ...
        with patch(
            ...
            assert len(result) == 1
            mock_agent_tool_call.assert_called_once_with(
                tool_name="unknown_tool", arguments={"arg": "value"}
            )
    ...
    def test_extract_tool_calls_none_arguments_uses_empty_dict(self):
        ...
        with patch(
            ...
            assert len(result) == 1
            mock_agent_tool_call.assert_called_once_with(
                tool_name="test_function", arguments={}
            )
...
class TestAgentResponseCallback:
    ...
    def test_agent_response_callback_successful_logging(
        ...
        with patch("backend.v4.callbacks.response_handlers.AgentMessage"):
            ...
            assert (
                len(call_args[3]) == 193
            )  # Message should be the actual length (not truncated in this case)
...
class TestStreamingAgentResponseCallback:
    ...
    async def test_streaming_callback_no_user_id(self):
        ...
        result = await streaming_agent_response_callback(
            "agent_123", mock_update, False, user_id=None
        )
    ...
    async def test_streaming_callback_with_text(self):
        ...
        with patch(
            ...
            await streaming_agent_response_callback(
                "agent_123", mock_update, True, user_id="user_456"
            )
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    ...
                    assert (
                        mock_tool_call in mock_tool_msg.tool_calls
                        or mock_tool_msg.tool_calls.extend.called
                    )
    ...
    async def test_streaming_callback_no_contents_attribute(self):
        ...
        with patch(
            ...
            with patch(
                ...
                mock_streaming.assert_called_once_with(
                    agent_name="agent_123", content="Test text", is_final=True
                )
