...
async def test_health_monitor():
    ...
    try:
        ...
        if "firestore" in active_providers:
            ...
            if firestore_health:
                print(f"   ✓ Firestore: healthy={firestore_health.is_healthy}, "
        ...
        if "aws_s3" in active_providers:
            ...
            if s3_health:
                print(f"   ✓ S3: healthy={s3_health.is_healthy}, "
        ...
        print(f"   Overall Health: {'🟢 HEALTHY' if snapshot.overall_health else '🔴 UNHEALTHY'}")
