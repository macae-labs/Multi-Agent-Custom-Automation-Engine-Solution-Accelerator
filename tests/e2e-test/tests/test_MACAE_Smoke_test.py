...
def test_macae_v4_gp_workflow(login_logout, request):
    ...
    try:
        ...
        try:
            ...
            logger.warning(
                "Initiating retry logic: Step 7 (New Task) → Retry Steps 3, 4, 5"
            )
            logger.warning("⚠" * 80)
            ...
            logger.info(
                f"Step 7 (Retry) completed in {step7_retry_end - step7_retry_start:.2f} seconds"
            )
            ...
            logger.info(
                f"Step 3 (Retry) completed in {step3_retry_end - step3_retry_start:.2f} seconds"
            )
            ...
            logger.info(
                f"Step 4 (Retry) completed in {step4_retry_end - step4_retry_start:.2f} seconds"
            )
            ...
            step5_end = time.time()
            logger.info(
                f"Step 5 (Retry) completed in {step5_end - step5_retry_start:.2f} seconds"
            )
        ...
        logger.info("\n" + "=" * 80)
        logger.info(
            "STEP 9: Selecting Quick Task and Creating Plan (Product Marketing)"
        )
        logger.info("=" * 80)
        ...
        logger.info("\n" + "=" * 80)
        logger.info(
            "STEP 28: Selecting Quick Task and Creating Plan (Contract Compliance)"
        )
        logger.info("=" * 80)
        ...
        logger.info(
            f"Step 3 (Retail Quick Task & Plan Creation): {step3_end - step3_start:.2f}s"
        )
        logger.info(
            f"Step 4 (Retail Agents Validation): {step4_end - step4_start:.2f}s"
        )
        logger.info(
            f"Step 5 (Retail Approve Task Plan): {step5_end - step5_start:.2f}s"
        )
        logger.info(
            f"Step 6 (Retail Customer Response Validation): {step6_end - step6_start:.2f}s"
        )
        logger.info(f"Step 7 (Click New Task): {step7_end - step7_start:.2f}s")
        logger.info(
            f"Step 8 (Product Marketing Team Selection): {step8_end - step8_start:.2f}s"
        )
        logger.info(
            f"Step 9 (Product Marketing Quick Task & Plan): {step9_end - step9_start:.2f}s"
        )
        logger.info(
            f"Step 10 (Product Marketing Agents Validation): {step10_end - step10_start:.2f}s"
        )
        logger.info(
            f"Step 11 (Product Marketing Approve Task Plan): {step11_end - step11_start:.2f}s"
        )
        logger.info(
            f"Step 12 (Product Marketing Response Validation): {step12_end - step12_start:.2f}s"
        )
        ...
        logger.info(
            f"Step 18 (HR Human Clarification): {step18_end - step18_start:.2f}s"
        )
        logger.info(
            f"Step 19 (HR Response Validation): {step19_end - step19_start:.2f}s"
        )
        ...
        logger.info(
            f"Step 22 (RFP Quick Task & Plan): {step22_end - step22_start:.2f}s"
        )
        logger.info(
            f"Step 23 (RFP Agents Validation): {step23_end - step23_start:.2f}s"
        )
        logger.info(
            f"Step 24 (RFP Approve Task Plan): {step24_end - step24_start:.2f}s"
        )
        logger.info(
            f"Step 25 (RFP Response Validation): {step25_end - step25_start:.2f}s"
        )
        logger.info(f"Step 26 (Click New Task): {step26_end - step26_start:.2f}s")
        logger.info(
            f"Step 27 (Contract Compliance Team Selection): {step27_end - step27_start:.2f}s"
        )
        logger.info(
            f"Step 28 (Contract Compliance Quick Task & Plan): {step28_end - step28_start:.2f}s"
        )
        logger.info(
            f"Step 29 (Contract Compliance Agents Validation): {step29_end - step29_start:.2f}s"
        )
        logger.info(
            f"Step 30 (Contract Compliance Approve Task Plan): {step30_end - step30_start:.2f}s"
        )
        logger.info(
            f"Step 31 (Contract Compliance Response Validation): {step31_end - step31_start:.2f}s"
        )
...
def test_validate_source_text_not_visible(login_logout, request):
    ...
    try:
        ...
        logger.info(f"Step 2 (Retail Team Selection): {step2_end - step2_start:.2f}s")
        logger.info(
            f"Step 3 (Quick Task & Plan Creation): {step3_end - step3_start:.2f}s"
        )
        logger.info(
            f"Step 4 (Retail Agents Validation): {step4_end - step4_start:.2f}s"
        )
        ...
        logger.info(
            f"Step 7 (Source Text Not Visible Validation): {step7_end - step7_start:.2f}s"
        )
        logger.info(f"Total Execution Time: {total_duration:.2f}s")
        logger.info("=" * 80)
...
def test_rai_validation_unable_to_create_plan(login_logout, request):
    ...
    try:
        ...
        step2_end = time.time()
        logger.info(
            f"Step 2 (Retail Team RAI Validation) completed in {step2_end - step2_start:.2f} seconds"
        )
        ...
        step3_end = time.time()
        logger.info(
            f"Step 3 (Product Marketing Team RAI Validation) completed in {step3_end - step3_start:.2f} seconds"
        )
        ...
        step4_end = time.time()
        logger.info(
            f"Step 4 (Human Resources Team RAI Validation) completed in {step4_end - step4_start:.2f} seconds"
        )
        ...
        step5_end = time.time()
        logger.info(
            f"Step 5 (RFP Team RAI Validation) completed in {step5_end - step5_start:.2f} seconds"
        )
        ...
        step6_end = time.time()
        logger.info(
            f"Step 6 (Contract Compliance Team RAI Validation) completed in {step6_end - step6_start:.2f} seconds"
        )
        ...
        logger.info(f"Step 1 (Home Page Validation): {step1_end - step1_start:.2f}s")
        logger.info(
            f"Step 2 (Retail Team RAI Validation): {step2_end - step2_start:.2f}s"
        )
        logger.info(
            f"Step 3 (Product Marketing Team RAI Validation): {step3_end - step3_start:.2f}s"
        )
        logger.info(
            f"Step 4 (Human Resources Team RAI Validation): {step4_end - step4_start:.2f}s"
        )
        logger.info(f"Step 5 (RFP Team RAI Validation): {step5_end - step5_start:.2f}s")
        logger.info(
            f"Step 6 (Contract Compliance Team RAI Validation): {step6_end - step6_start:.2f}s"
        )
        logger.info(f"Total Execution Time: {total_duration:.2f}s")
        logger.info("=" * 80)
        logger.info(
            "✓ RAI Validation Test PASSED - All 5 teams correctly blocked harmful prompts"
        )
        logger.info("=" * 80)
...
def test_cancel_button_all_teams(login_logout, request):
    ...
    try:
        ...
        step2_end = time.time()
        logger.info(
            f"Step 2 (Retail Team Cancel) completed in {step2_end - step2_start:.2f} seconds"
        )
        ...
        step3_end = time.time()
        logger.info(
            f"Step 3 (Product Marketing Team Cancel) completed in {step3_end - step3_start:.2f} seconds"
        )
        ...
        step4_end = time.time()
        logger.info(
            f"Step 4 (Human Resources Team Cancel) completed in {step4_end - step4_start:.2f} seconds"
        )
        ...
        step5_end = time.time()
        logger.info(
            f"Step 5 (RFP Team Cancel) completed in {step5_end - step5_start:.2f} seconds"
        )
        ...
        step6_end = time.time()
        logger.info(
            f"Step 6 (Contract Compliance Team Cancel) completed in {step6_end - step6_start:.2f} seconds"
        )
        ...
        logger.info(
            f"Step 3 (Product Marketing Team Cancel): {step3_end - step3_start:.2f}s"
        )
        logger.info(
            f"Step 4 (Human Resources Team Cancel): {step4_end - step4_start:.2f}s"
        )
        logger.info(f"Step 5 (RFP Team Cancel): {step5_end - step5_start:.2f}s")
        logger.info(
            f"Step 6 (Contract Compliance Team Cancel): {step6_end - step6_start:.2f}s"
        )
        logger.info(f"Total Execution Time: {total_duration:.2f}s")
        logger.info("=" * 80)
        logger.info(
            "✓ Cancel Button Test PASSED - All 5 teams successfully returned to home page"
        )
        logger.info("=" * 80)
...
def test_cancel_functionality_all_teams(login_logout, request):
    ...
    request.node._nodeid = (
        "(MACAE V4) Test Cancel functionality in the Plan Approval step"
    )
    ...
    try:
        ...
        step2_end = time.time()
        logger.info(
            f"Steps 3-5 (HR Team Cancel) completed in {step2_end - step2_start:.2f} seconds"
        )
        ...
        step3_end = time.time()
        logger.info(
            f"Steps 6-8 (Product Marketing Cancel) completed in {step3_end - step3_start:.2f} seconds"
        )
        ...
        step4_end = time.time()
        logger.info(
            f"Steps 9-11 (Retail Team Cancel) completed in {step4_end - step4_start:.2f} seconds"
        )
        ...
        step5_end = time.time()
        logger.info(
            f"Steps 12-14 (RFP Team Cancel) completed in {step5_end - step5_start:.2f} seconds"
        )

        # Step 15-17: Test Cancel - Contract Compliance Review Team
        logger.info("\n" + "=" * 80)
        logger.info(
            "STEPS 15-17: Testing Cancel Button - Contract Compliance Review Team"
        )
        logger.info("=" * 80)
        step6_start = time.time()
        ...
        step6_end = time.time()
        logger.info(
            f"Steps 15-17 (Contract Compliance Cancel) completed in {step6_end - step6_start:.2f} seconds"
        )
        ...
        logger.info(
            f"Steps 6-8 (Product Marketing Cancel): {step3_end - step3_start:.2f}s"
        )
        ...
        logger.info(
            f"Steps 15-17 (Contract Compliance Cancel): {step6_end - step6_start:.2f}s"
        )
        logger.info(f"Total Execution Time: {total_duration:.2f}s")
        logger.info("=" * 80)
...
def test_rai_prompt_in_clarification(login_logout, request):
    ...
    try:
        ...
        logger.info(
            f"Step 6 (RAI Prompt in Clarification): {step5_end - step5_start:.2f}s"
        )
        logger.info(f"Total Execution Time: {total_duration:.2f}s")
        logger.info("=" * 80)
...
def test_rai_prompts_all_teams(login_logout, request):
    ...
    try:
        ...
        step2_end = time.time()
        logger.info(
            f"Steps 3-4 (HR Team RAI) completed in {step2_end - step2_start:.2f} seconds"
        )
        ...
        step3_end = time.time()
        logger.info(
            f"Steps 5-6 (Product Marketing RAI) completed in {step3_end - step3_start:.2f} seconds"
        )
        ...
        step4_end = time.time()
        logger.info(
            f"Steps 7-8 (Retail Team RAI) completed in {step4_end - step4_start:.2f} seconds"
        )
        ...
        step5_end = time.time()
        logger.info(
            f"Steps 9-10 (RFP Team RAI) completed in {step5_end - step5_start:.2f} seconds"
        )
        ...
        step6_end = time.time()
        logger.info(
            f"Steps 11-12 (Contract Compliance RAI) completed in {step6_end - step6_start:.2f} seconds"
        )
        ...
        logger.info(
            f"Steps 5-6 (Product Marketing RAI): {step3_end - step3_start:.2f}s"
        )
        ...
        logger.info(
            f"Steps 11-12 (Contract Compliance RAI): {step6_end - step6_start:.2f}s"
        )
        logger.info(f"Total Execution Time: {total_duration:.2f}s")
        logger.info("=" * 80)
...
def test_duplicate_team_entries(login_logout, request):
    ...
    try:
        ...
        for team in teams_to_check:
            ...
            if count > 1:
                logger.error(
                    f"❌ Duplicate entries found for '{team}': {count} entries"
                )
        ...
        logger.info(f"Step 1 (Open Application): {step1_end - step1_start:.2f}s")
        logger.info(
            f"Steps 2-5 (Validate Unique Teams): {step2_end - step2_start:.2f}s"
        )
        logger.info(f"Total Execution Time: {total_duration:.2f}s")
        logger.info("=" * 80)
...
def test_cross_team_agent_validation(login_logout, request):
    ...
    try:
        ...
        logger.info(
            f"Step 12 (HR Human Clarification): {step12_end - step12_start:.2f}s"
        )
        logger.info(
            f"Step 13 (HR Response Validation): {step13_end - step13_start:.2f}s"
        )
        logger.info(f"Total Execution Time: {total_duration:.2f}s")
        logger.info("=" * 80)
